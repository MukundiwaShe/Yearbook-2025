...
const studentsData = [
  ...
  },
  {
    ...
    specialization: 'Digital Marketing',
    hub: 'Dzivarasekwa',
    photo: '/images/munashe-chari.jpg',
  ...
  // Development Students
  {
    ...
    projectImage: '/images/my-project.png',
    linkedinUrl: 'https://www.linkedin.com/in/nicole-zonke-profile', // Example LinkedIn
    githubUrl: 'https://github.com/nicolezonke/yearbook-project', // Example GitHub
  },
  {
    id: 'dev-2',
  ...
  },
  {
    ...
    projectTitle: 'Online Learning Platform Prototype',
    projectDescription: 'Developed a prototype for an online learning platform with features for course creation, student enrollment, and progress tracking, focusing on user-friendly interface.',
    projectImage: 'https://placehold.co/400x250/10B981/FFFFFF?text=Dev+Project+4',
    linkedinUrl: 'https://www.linkedin.com/in/michael-dendere-profile',
    githubUrl: 'https://github.com/michaeldendere/learning-platform',
  },
  {
    id: 'dev-5',
...

  {
    ...
    projectTitle: 'Portfolio Website Generator',
    projectDescription: 'Created a tool that allows users to quickly generate personalized portfolio websites by inputting their details and project information.',
    projectImage: 'https://placehold.co/400x250/1A56DB/FFFFFF?text=Dev+Project+7',
    linkedinUrl: 'https://www.linkedin.com/in/tafadzwa-kanhoodza-profile',
    githubUrl: 'https://github.com/tafadzwa-k/portfolio-generator',
  },
  {
    id: 'dev-8',
  ...
  },
  {
    ...
    specialization: 'Development',
    hub: 'Dzivarasekwa',
    photo: '/images/sota.jpg', // Placeholder, replace with actual if available
  ...
  },
  {
    ...
    projectTitle: 'Packaging Design for Organic Products',
    projectDescription: 'Designed eco-friendly and visually appealing packaging for a new line of organic food products, focusing on sustainability and brand messaging.',
    projectImage: 'https://placehold.co/400x250/1A56DB/FFFFFF?text=Design+Project+6',
    linkedinUrl: 'https://www.linkedin.com/in/lorraine-profile',
    githubUrl: null,
  },
  {
    id: 'des-7',
...
const instructorsData = [
  {
    ...
    name: 'Fadzai',
    role: 'Instructor',
    photo: '/images/fadzai.jpg', // Placeholder, replace with actual if available
  ...
  },
  {
    ...
    photo: '/images/simba.jpg', // Placeholder, replace with actual if available
  ...
  },
  {
    ...
    name: 'Collin',
    role: 'Instructor',
    photo: '/images/collin.jpg', // Placeholder, replace with actual if available
